...
elegoo_pla_basic =
  Repo.insert!(%Product{
    ...
    material: pla,
    variant: basic,
    name: "Elegoo - PLA Basic",
    weight_grams: 1_000,
    spool_weight_grams: 175
  })
...
bambu_pla_basic_black =
  Repo.insert!(
    Filament.changeset(%Filament{}, %{
      product_id: bambu_pla_basic.id,
      color_name: "Black",
      color_hex: "#000000"
    })
  )
...
Repo.insert!(
  Filament.changeset(%Filament{}, %{
    product_id: elegoo_pla_basic.id,
    color_name: "Black",
    color_hex: "#000000"
  })
)
...
Repo.insert!(
  Filament.changeset(%Filament{}, %{
    product_id: elegoo_petg_basic.id,
    color_name: "Red",
    color_hex: "#ea140e"
  })
)
